...
if($_SERVER['REQUEST_METHOD'] === 'POST'){}
  ...
  $sql="  UPDATE lastwebsite SET link = ('http://localhost/workspace1/das-aue-der-zeitedit.php') WHERE id = 1;";
  mysqli_query($con, $sql);
  header('Location: http://localhost/workspace1/_login.php');
        exit();
}
require_once('config/db_connect.php');
$sql = "SELECT inhalt FROM content WHERE idnr=19;";
$buch = mysqli_query($con, $sql);
?>
<!DOCTYPE html>
<html lang="de">
  <head>
  ...
  <body>
    <div class="site">
      ...
      <div class="cc content8" styles= "grid-area: i0; height: 100;">
          <div class="kontakti0">
            <img src="images/buch titelbild.jpg" alt="">
          </div>
          <div class="kontaktt0">
          <form action="process.php" method="POST">
           <input type="hidden" name="idnr" value="19" class="editnr">
                <textarea class="editbox" style="height: 400px;" name="content" id="Article_editor">
                    <?php
                    echo implode(mysqli_fetch_assoc($buch));
                    ?>
                </textarea>
