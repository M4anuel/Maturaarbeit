...
$sql = "SELECT inhalt FROM content WHERE idnr=11;";
$zitat = mysqli_query($con, $sql);
$sql = "SELECT inhalt FROM content WHERE idnr=12;";
$verkäufe = mysqli_query($con, $sql);
?>
<!DOCTYPE html>
<html lang="de">
  <head>
  ...
  <body>
    <div class="site">
      ...
      <div class="cc content7" styles= "grid-area: i0; height: 100;">
          <div class="ausstellungeni0">
            <img src="images/ausstellungen.jpg" alt="">
          </div>
          <div class="ausstellungent0">
          <form action="process.php" method="POST">
           <input type="hidden" name="idnr" value="10" class="editnr">
                <textarea class="editbox" style="height: 400px;" name="content" id="Article_editor">
                    <?php
                    echo implode(mysqli_fetch_assoc($ausstellungen));
                    ?>
                </textarea>
          ...
          <form class="form" action="process.php" method="POST">
           <input type="hidden" name="idnr" value="12" class="editnr">
                <textarea class="editbox" style="height: 400px;" name="content" id="Article_editor2">
                    <?php
                    echo implode(mysqli_fetch_assoc($verkäufe));
                    ?>
                </textarea>
                <input type="submit" class="publish-btn" name="submit_data" value="publish">
            </form>
